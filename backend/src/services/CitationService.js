...
exports.updateCitation = async (id, data, user) => {
  ...
  try {
    ...
    console.log("allowedFields",data)
    ...
    if (keys.includes("citation_fds")) {
      ...
      // const citationIssuedInDb = paramResult.rows[0]?.citation_issued;
      // console.log(citationIssuedInDb,"citationIssuedInDb")
      // console.log("citationIssued",citation_issued) // Update citation_issued only if status is "approved" and client-side sent citation_issued as true
