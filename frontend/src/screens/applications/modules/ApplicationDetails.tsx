...
// console.log(memberData)
  ...
  if (paramData.length > 0) {
    doc.text("Parameters", 14, 15);
    autoTable(doc, {
      startY: 20,
      head: [["Category", "Subcategory", "Subsubcategory", "Name", "Marks"]],
      body: paramData,
    });
  }

  // Members Table (append below)
  // if (memberData.length > 0) {
  //   const finalY = (doc as any).lastAutoTable.finalY || 30; // position after previous table
  //   doc.text("Members", 14, finalY + 15);
  //   autoTable(doc, {
  //     startY: finalY + 20,
  //     head: [["Name", "Rank", "Type"]],
  //     body: memberData,
